...
public class MedicosDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE "
                + MedicosContract.PacienteEntry.TABLE_NAME +
                "("
                + MedicosContract.PacienteEntry._ID
                + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                ...
                + " TEXT,"
                + "UNIQUE (" + MedicosContract.PacienteEntry.ID + "),"
                + " FOREIGN KEY (" + MedicosContract.PacienteEntry.ID_MEDICO +") REFERENCES "
                + MedicosContract.MedicoEntry.TABLE_NAME + "(" + MedicosContract.MedicoEntry.ID + "))"
    ...
    public long mockMedicos(SQLiteDatabase db
            , Pacientes pacientes){
        return db.insert(MedicosContract.PacienteEntry.TABLE_NAME
                ,null
    ...
    public Cursor getAllPacientesByIdMedico(String medicoId){
        return getReadableDatabase()
                .query(MedicosContract.PacienteEntry.TABLE_NAME
                        ,null
                        , MedicosContract.PacienteEntry.ID_MEDICO + " LIKE ?"
                        ,new String[] {medicoId}
                        ,null
                        ,null
                        ,null);
    ...
    public int updatePaciente(Pacientes pacientes
        ...
        return getWritableDatabase().update(
                MedicosContract.PacienteEntry.TABLE_NAME
                ,pacientes.toContentValues()
                , MedicosContract.PacienteEntry.ID+" LIKE ?"
