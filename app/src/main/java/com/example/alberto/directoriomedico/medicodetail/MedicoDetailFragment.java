...
import com.example.alberto.directoriomedico.PacientesActivity;
...
public class MedicoDetailFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.action_delete:
                ...
                break;
            case R.id.action_patientsList:
                showMedicoListPacientes();
                break;
    ...
    //abrir activity de listado de pacientes
    private void showMedicoListPacientes(){

        Intent intent = new Intent(getActivity(),PacientesActivity.class);
